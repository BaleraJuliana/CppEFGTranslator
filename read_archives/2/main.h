      ...
      */
      class TEQTWIDGETSEXPORT RasterSymbolizerWidget : public QWidget
      {
        ...
        private:
          ...
          std::unique_ptr<Ui::RasterSymbolizerWidgetForm> m_ui;             //!< Widget form.
          te::qt::widgets::HorizontalSliderWidget* m_sliderWidget;        //!< Slider widget used for opacity information.
          te::qt::widgets::RasterHistogramWidget* m_histogramWidget;      //!< Histogram widget.

          te::qt::widgets::MapDisplay* m_display;

          te::se::RasterSymbolizer* m_symbolizer;                         //!< SE Raster Symbolizer element.
          te::map::RasterContrast* m_contrast;                            //!< Raster Contrast element.
          ...
          std::map<te::rp::Contrast::InputParameters::ContrastType, te::map::RasterTransform::ContrastType> m_contrastMap;   //!< Contrast Types Names
