      ...
      */
      class TEQTWIDGETSEXPORT TableLinkDialog : public QDialog
      {
        ...
        private:
          ...
          std::vector<std::string>                m_uniqueProps;   //!< The name of the properties that must be unique in the output layer.
          std::unique_ptr<DataSetTableView>         m_tabularView;   //!< The widget used to preview the data of the tabular dataset.
          std::unique_ptr<Ui::TableLinkDialogForm>  m_ui;            //!< The widget's form.
      };
